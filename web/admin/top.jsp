...
<div class="top_box">
    <div class="top_logo"><div align="center" style="color: #CCFFCC;font-size: 16pt;font-weight: bold;">学生成绩管理</div></div>
    <div class="top_nav">
      <div class="top_nav_sm">
         ...
         <div class="top_nav_xm">
             <div class="navtit" id="navtit">
                <span onclick="changeMenu(this);"  class="hover"><a href="<%=path %>/admin/main.jsp" target='main'><i>首页</i></a></span>
 				<span onclick="changeMenu(this);">
                <a href="<%=path %>/admin/userinfo/userPw.jsp" target="main"><i>修改密码</i></a>
                 </span>
    ...
    <div class="top_she">   
		<a href="#" onclick="logout()">安全注销</a>   </div>
    </div>
</div>
</body>
</html>
